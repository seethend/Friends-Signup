								...
								<c:if test="${forow.STATUS==0}">
									<div style="top: 25%;" id="main-div">
										...
										<div id="a-content">
											...
											<hr>
											<a name="${row.USER_ID}" href="#" onclick="sendDelete(this.name,${sessionScope.UID},1)">Cancel Request</a>
										</div>
									</div>
								...
								<c:if test="${forow.STATUS==1}">
									<div style="top: 25%;" id="main-div">
										...
										<div id="a-content">
											<a id="${forow.MSGCHN}" href="#" onclick="showbox(${row.USER_ID},${sessionScope.UID},'${row.FIRSTNAME}',this.id);proxy.login();">Message</a>
											<hr>
											<a name="${row.USER_ID}" href="#" onclick="sendDelete(this.name,${sessionScope.UID},1)">Unfriend</a>
										</div>
									</div>
									<c:set var="check" value="False"/>
								</c:if>
